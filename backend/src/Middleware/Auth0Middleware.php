...
class Auth0Middleware implements MiddlewareInterface
{
    ...
    public function process(Request $request, RequestHandlerInterface $handler): Response
    {
        ...
        try {
            ...
            // Add both Auth0 user info and Planet Trader user to request
        ...
        try {
            ...
            if (!$user) {
                ...
                $user = User::create([
                    ...
                    'display_name' => $auth0User->name ?? $auth0User->email ?? 'Trader',
                    'credits' => 10000, // Default starting credits for Planet Trader
                    'level' => 1,
                    'experience' => 0,
                    'reputation' => 0,
                    'role' => 'trader', // Default role for Planet Trader
                    'is_active' => true,
