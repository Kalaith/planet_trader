-- Planet Trader backend schema.
-- Apply with a configured MySQL/MariaDB connection before enabling backend APIs.
...
CREATE TABLE IF NOT EXISTS game_sessions (
    ...
    INDEX idx_game_sessions_player (player_id),
...
CREATE TABLE IF NOT EXISTS planets (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    INDEX idx_planets_session (session_id),
    INDEX idx_planets_type (planet_type_id),
    INDEX idx_planets_species (species_id),
    CONSTRAINT fk_planets_session
        FOREIGN KEY (session_id) REFERENCES game_sessions(id) ON DELETE CASCADE,
    CONSTRAINT fk_planets_type
        FOREIGN KEY (planet_type_id) REFERENCES planet_types(id),
    CONSTRAINT fk_planets_species
...
CREATE TABLE IF NOT EXISTS player_tools (
    ...
    CONSTRAINT fk_player_tools_player
        FOREIGN KEY (player_id) REFERENCES players(id) ON DELETE CASCADE,
    CONSTRAINT fk_player_tools_tool
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    CONSTRAINT fk_transactions_session
        FOREIGN KEY (session_id) REFERENCES game_sessions(id) ON DELETE CASCADE,
    CONSTRAINT fk_transactions_planet
